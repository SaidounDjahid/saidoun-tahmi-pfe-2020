  ...
  return (
    <div className={modalCSS}>
      <div className={[zoomIn, 'dialog'].join(' ')}>
        <h1>Confirmer choix de vote ? ( Une fois confirmé vous ne pourrez plus le modifier) </h1>
        <h2>Vos données</h2>
        <div className="flex">
          <h3>
            Prénom:
        ...
        <div className="flex buttons">
          ...
          <Button text="Confirmer" click={() => dataConfirmed({ voter, candidate })} nonDefaultCss={confirmButtonCSS} />
        </div>
