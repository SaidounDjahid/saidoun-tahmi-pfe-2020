...
`;
// fonction qui fait le graphique et calcule les résultats du vote pour chaque candidat ansi que le %
      ...
      {sortedCandidates.map((candidate) => (
        <article key={candidate.name}>
          ...
          <div className="datacontainer">
            ...
            <h4 className="house">{candidate.house !== 'White Walkers' ? ` ${candidate.house}` : candidate.house}</h4>
